...
win_obj=GraphWin("Rotation Window",900,900) 
...
###############  Rotation ################################
flag=int(input("Enter 1 for Rotation aobut Z-axis, 2 for Y-axis ,3 for X - axis:"))

## Along Z-axis   #####

if(flag==1):
	tx = int(input("Enter angle to rotate (Degree) or Enter 0:"))

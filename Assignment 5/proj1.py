...
win_obj=GraphWin("Ortho Projection",900,900) 
...
vertex1=vertex3
vertex2=vertex4
print("Enter the principle plane 1 for xy or 2 for yz or 3 for xz:")
k1=int(input("Enter digit"))
vertex3=[]
vertex4=[]
if(k1==1):
    for i in range(c):
        vertex1[i][2]=0
        vertex2[i][2]=0
    drawSolid(vertex1,vertex2,clr2)
elif (k1==2):
    for i in range(c):
        vertex1[i][0]=0
        vertex2[i][0]=0

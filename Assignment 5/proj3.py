...
win_obj=GraphWin("Perspective Projection",900,900) 
...
for i in range(c):
    ...
    y=vertex1[i][1]
    z=vertex1[i][2]
    if((n1*x+n2*y+n3*z-d1)==0):
            print("Grazing Case (div byzero)")
            exit(0)
    
    x0 = (x*(a1*n1+d)+y*a1*n2+z*a1*n3-a1*d0)/(n1*x+n2*y+n3*z-d1)
    x0=int(x0)
    point.append(x0)
    y0 = (x*b1*n1+y*(b1*n2+d)+z*b1*n3-b1*d0)/(n1*x+n2*y+n3*z-d1)
    y0=int(y0)
    point.append(y0)
    z0 =( x*c1*n1 +y*c1*n2 +z*(c1*n3+d)- c1*d0)/(n1*x+n2*y+n3*z-d1)
    z0=int(z0)
    point.append(z0)
    vertex3.append(point)
    ...
    point=[]
    x1 = (x*(a1*n1+d)+y*a1*n2+z*a1*n3-a1*d0)/(n1*x+n2*y+n3*z-d1)
    x1=int(x1)
    point.append(x1)
    y1 = (x*b1*n1+y*(b1*n2+d)+z*b1*n3-b1*d0)/(n1*x+n2*y+n3*z-d1)
    y1=int(y1)
    point.append(y1)
    z1 =( x*c1*n1 +y*c1*n2 +z*(c1*n3+d)- c1*d0)/(n1*x+n2*y+n3*z-d1)
    z1=int(z1)
    point.append(z1)
    vertex4.append(point)
